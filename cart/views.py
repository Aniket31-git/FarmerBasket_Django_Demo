...
def checkout(request):
    ...
    messages.success(request, 'Checkout complete — your order is placed!')
    
    context = {
        'cart_items': session_cart,  # Show items in checkout summary (optional)
